...
import { getHubs } from "../../shared/api/logistics";
...
const FirebaseSettings = ({ settings = {}, onSave }) => {
    ...
    const handleTestFirebaseOTP = async () => {
        ...
        try {
            ...
            const { initializeFirebase, getFirebaseAuth, RecaptchaVerifier, signInWithPhoneNumber } = await import("../../shared/utils/firebase");
